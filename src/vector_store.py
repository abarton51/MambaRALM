...
class RAGVectorStore:
    ...
    def create_db(self, db_name : str, data_dir : str, store_type="FAISS", chunk_size: int = 1000, chunk_overlap: int = 30, verbose : bool = False) -> object:
        ...
        #document loader
        loader = DirectoryLoader(data_dir, glob="**/*.txt", loader_cls=TextLoader, use_multithreading=True, show_progress=True)
        ...
        docs = list(itertools.chain.from_iterable(loader.load()))
            ...
            with tqdm(total=len(documents_split), desc="Ingesting documents") as pbar:
                ...
                for d in documents_split:
                    ...
                    if db:
                        ...
                        db = FAISS.from_documents([d], embedding_model)
