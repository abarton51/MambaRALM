...
class RAGVectorStore:
    ...
    def get_db(self, verbose : bool = False) -> object:
        """Returns fully initialized vector database with similiarity search native to the vector store type (self.store_type)
        and vector embeddings generated by specified embedding model (self.embedding_model).
